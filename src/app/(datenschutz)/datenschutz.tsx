...
import { A, H1, H2, H3, H4, Main, P } from "@expo/html-elements";
...
export default function Datenschutz() {
  ...
  const textStyle = [styles.ltrText, { color: colors.text }];
  const paragraphStyle = [styles.paragraph, ...textStyle];
  const linkStyle = [styles.link, ...textStyle, { color: colors.tint }];
  const emphasisParagraphStyle = [
    styles.paragraph,
    styles.emphasis,
    ...textStyle,
  ];
    ...
    <View style={styles.list}>
      {items.map((item) => (
        <View key={item} style={styles.listRow}>
          <Text style={[styles.listMarker, ...textStyle]}>{listMarker}</Text>
    ...
    <SafeAreaView style={{ flex: 1 }} edges={["top", "bottom"]}>
      ...
      >
        <Main style={styles.innerContainer}>
          <H1 style={[styles.heading, ...textStyle]}>Datenschutzerklärung</H1>

          <H2 style={[styles.sectionHeading, ...textStyle]}>
            1. Datenschutz auf einen Blick
          </H2>

          <H3 style={[styles.subheading, ...textStyle]}>Allgemeine Hinweise</H3>
          ...
          <H3 style={[styles.subheading, ...textStyle]}>
            Datenerfassung auf dieser Website
          </H3>
          <H4 style={[styles.detailHeading, ...textStyle]}>
          ...
          <H2 style={[styles.sectionHeading, ...textStyle]}>2. Hosting</H2>
          <P style={paragraphStyle}>
            Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
          </P>

          <H3 style={[styles.subheading, ...textStyle]}>Externes Hosting</H3>
          <P style={paragraphStyle}>
          ...
          <P style={paragraphStyle}>Wir setzen folgende(n) Hoster ein:</P>
          <P style={paragraphStyle}>
            Webhosting über GitHub Pages{"\n"}
            GitHub, Inc.{"\n"}
            88 Colin P. Kelly Jr. St.{"\n"}
            San Francisco, CA 94107{"\n"}
            USA{"\n"}
            {"\n"} 
            Europäischer Ansprechpartner / Datenschutzkontakt:{"\n"}
            GitHub B.V.{"\n"}
          ...
          <H3 style={[styles.subheading, ...textStyle]}>Datenschutz</H3>
          <P style={paragraphStyle}>
          ...
          <P style={paragraphStyle}>
            Hadi El Ali, Mangenberger Straße 206 in 42655 Solingen
          </P>
          <P style={paragraphStyle}>
            Telefon: 0157 85 69 19 87{"\n"}
            E-Mail: hadielali@web.de
          </P>
          <P style={paragraphStyle}>
          ...
          <H3 style={[styles.subheading, ...textStyle]}>Speicherdauer</H3>
          <P style={paragraphStyle}>
          ...
          <P style={emphasisParagraphStyle}>
          ...
          <H3 style={[styles.subheading, ...textStyle]}>Cookies</H3>
          <P style={paragraphStyle}>
          ...
          <H3 style={[styles.subheading, ...textStyle]}>Server-Log-Dateien</H3>
          <P style={paragraphStyle}>
          ...
          <P style={paragraphStyle}>
            ...
            eingesetzt. Anzeigen, die im erweiterten Datenschutzmodus
            ...
            Browser des Users gespeichert, die ähnlich wie Cookies
            personenbezogene Daten beinhalten und zur Wiedererkennung eingesetzt
            werden können. Details zum erweiterten Datenschutzmodus finden Sie
            hier:{" "}
          ...
          <P style={paragraphStyle}>
            ...
            <Link href="https://www.dataprivacyframework.gov/participant/5780">
